---
id: index
title: "Sales Planning Purchase"
sidebar_label: "Sales Planning Purchase"
---

# Sales Planning Purchase

## Overview

Technical module: `dx_sale_planning_purchase`
...
- Dependencies: `dx_sale_planning_stock`, `purchase_stock`

Install the declared dependencies first, then install `Sales Planning Purchase` from Odoo Apps. Do not assume a dependency is available in another Odoo version.
...
3. Install `Sales Planning Purchase` and follow the source-backed menus and workflows below.
...
- Static source files: 8 Python, 2 XML, and 1 CSV.
- Detected model names: `sale.plan.purchase.wizard`
