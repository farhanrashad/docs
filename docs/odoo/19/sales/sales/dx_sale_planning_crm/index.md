---
id: index
title: "Sales Planning CRM"
sidebar_label: "Sales Planning CRM"
---
...
Technical module: `dx_sale_planning_crm`
...
- Dependencies: `dx_sale_planning`, `crm`

Install the declared dependencies first, then install `Sales Planning CRM` from Odoo Apps. Do not assume a dependency is available in another Odoo version.
...
3. Install `Sales Planning CRM` and follow the source-backed menus and workflows below.
...
- Static source files: 6 Python, 2 XML, and 0 CSV.
