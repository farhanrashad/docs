---
id: index
title: "Sales Planning Manufacturing"
sidebar_label: "Sales Planning Manufacturing"
---
...
Technical module: `dx_sale_planning_mrp`
...
- Dependencies: `dx_sale_planning_stock`, `mrp`

Install the declared dependencies first, then install `Sales Planning Manufacturing` from Odoo Apps. Do not assume a dependency is available in another Odoo version.
...
3. Install `Sales Planning Manufacturing` and follow the source-backed menus and workflows below.
...
- Detected model names: `sale.plan.mrp.wizard`
